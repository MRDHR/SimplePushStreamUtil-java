...
public class JschUtil {
    ...
    public void runCmd(String cmd, String charset, PushStreamRunnable.PushStreamCallBack pushStreamCallBack) throws Exception {
        ...
        new Thread(new PushStreamRunnable(channelExec.getErrStream(), pushStreamCallBack)).start();
        new Thread(new PushStreamRunnable(channelExec.getInputStream(), pushStreamCallBack)).start();
    }
